...
const mainMenu = {
  reply_markup: {
    keyboard: [
      ...
      [{ text: "🎯 Подобрать программу" }, { text: "👩‍💼 О тренере" }],
...
*Готовы начать?* Подберите программу, чтобы я подобрала идеальную программу именно для вас!`;
...
function startQuiz(chatId, userId) {
  ...
  const text = `🎯 *Подбор идеальной программы*
...
function showQuizResult(chatId, userId) {
  ...
  const text = `🎉 *Результат подбора программы*
...
Подберите программу и начните свой путь к идеальной форме!`;

  const menu = {
    reply_markup: {
      keyboard: [
        [{ text: "🎯 Подобрать программу" }, { text: "💪 Программы" }],
        [{ text: "🏠 Главное меню" }]
      ],
      resize_keyboard: true
    }
...
*Готовы начать?* Подберите программу для подбора идеальной программы!`;
